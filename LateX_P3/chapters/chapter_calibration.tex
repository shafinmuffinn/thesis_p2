...
(Section~\ref{sec:cal_baseline}). What the learned heads can do that averaging cannot
is examined in Section~\ref{sec:cal_labelled}, where the calibration clips are also
labelled. Section~\ref{sec:cal_mechanism} shows that calibration removes linearly
...
were, on identical clips. \pend{labelled averaging results: table + tests + one-paragraph verdict}
...
80.4--81.9\%, with dropout-trained attention the most accurate---and
\pend{verdict of labelled averaging vs labelled heads}. The attention weighting is
