...
training recipe; only the normalisation differs).}
\label{tab:cal_effect}
\begin{tabular}{lcccc}
\hline
\textbf{Head} & \textbf{Default} & \textbf{Calibrated} & \textbf{Change} & \textbf{$p_{\mathrm{Holm}}$} \\
\hline
Concat-MLP              & 58.80\% & 75.93\% & $+17.13$ pp & \pend{calib\_effect\_tests.csv} \\
Modality dropout (full) & 58.77\% & 75.02\% & $+16.25$ pp & \pend{calib\_effect\_tests.csv} \\
Cross-attention         & 57.61\% & 73.87\% & $+16.26$ pp & \pend{calib\_effect\_tests.csv} \\
Modality dropout (AV)   & 57.89\% & 73.57\% & $+15.68$ pp & \pend{calib\_effect\_tests.csv} \\
\hline
\end{tabular}
\end{table}
