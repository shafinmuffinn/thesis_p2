...
\textbf{The zero-EEG demonstration path survives.} The claim that the dropout model
...
\begin{figure}[htbp]
\centering
\IfFileExists{images/fig_audit_suppression.png}{\includegraphics[width=0.95\textwidth]{images/fig_audit_suppression.png}}{\fbox{\parbox{0.9\textwidth}{\centering Missing image placeholder: \texttt{images/fig\_audit\_suppression.png} (left: within-subject suppression matrix; right: EEG confident-error matrix on audio-vision-correct trials; same colour scale).}}}
