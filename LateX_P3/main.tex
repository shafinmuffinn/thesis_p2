...
\usepackage{xcolor} % \pend{} markers
\usepackage{booktabs}
...
% A value not yet traced to a results CSV. verify_latex.py counts these; the
% submitted PDF must contain none.
...
\chapter{Proposed Methodology and Architectural Design}
\input{chapters/chapter_4.tex}

\chapter{Implementation and Experimental Setup}
\input{chapters/chapter_5.tex}

\chapter{Within-Subject Results}
\label{chap:within}
\input{chapters/chapter_6.tex}

\chapter{Cross-Subject Evaluation}
\label{chap:crosssubject}
\input{chapters/chapter_7_crosssubject.tex}

\chapter{Unsupervised Subject Calibration}
\label{chap:calibration}
\input{chapters/chapter_calibration.tex}

\chapter{Evaluation Integrity Audit}
\label{chap:audit}
\input{chapters/chapter_audit.tex}

\chapter{Engineering Challenges and Solutions}
\label{chap:engineering_challenges}
